package com.github.xuejike.springboot.print.driver.file;
...
public class QiniuFileDrive extends BaseFileDrive implements FileDrive {
    ...
    //要上传的空间
    String fileBucketName = "bidanet";
    String tempPath="/temp";
    public static String fileHost="http://oiu2fev6o.bkt.clouddn.com/";
    //密钥配置
    ...
    @Override
    public String uploadToFileName(InputStream in, String newName, String prefix) throws IOException {
        String s = uploadTempFile(in, newName);
        String url = uploadQiNiu(s, prefix + createRandomName(newName));
        FileUtils.deleteQuietly(new File(s));
        return url;
    }
    ...
    @Override
    public String uploadImg(InputStream in, String oldName, String prefix) throws IOException {
        return uploadToFileName(in,createRandomName(oldName),prefix);
    }
    ...
    @Override
    public String uploadTempImgPackage(File file, String saveName,String directoryName) throws IOException {
        return null;
    }
}
