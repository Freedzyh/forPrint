...
public interface FileDrive {
    ...
    String uploadToFileName(InputStream in, String newName, String prefix) throws IOException;
    ...
    String uploadImg(InputStream in, String oldName, String prefix) throws IOException;

    File uploadToLocation(InputStream in, String newName) throws IOException;

    String uploadTempImgPackage(File file, String saveName, String directoryName) throws IOException;
}
